 ...
 *
 * Сценарий б) требует аккуратной инициализации: не манипулируем history,
 * а просто проверяем текущий хэш при старте.
 */
...
function initRouter(playerApi) {
  ...
  //     сразу ставим обёртку в «приближённое» состояние без
  //     анимации (вариант 3): пользователь не ждёт 1.4с наезда,
  //     но при выходе из игры увидит нормальный отъезд камеры
  //     и плавный возврат на сцену.
  if (location.hash === '#game') {
    setZoomedTV();
    _showGame();
  }
